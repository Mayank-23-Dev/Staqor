    ...
    <main className="mode-auth min-h-screen bg-[#07070A] text-foreground flex items-center justify-center p-6 relative">
      ...
      <Card className="w-full max-w-md bg-[#0C0C12] border-border relative z-10 shadow-2xl">
        <CardHeader className="space-y-2 text-center">
          ...
          <CardTitle className="text-2xl font-bold">Create Staqor Account</CardTitle>
          <CardDescription className="text-muted-foreground text-xs">
            Join developers practicing frontend challenges with real-time AI scoring
          </CardDescription>
        </CardHeader>
        ...
        {successMessage ? (
          <CardContent className="space-y-4 pt-2 text-center">
            <div className="p-6 rounded-xl bg-emerald-950/20 border border-emerald-500/30 space-y-3">
              <CheckCircle2 className="w-10 h-10 text-emerald-400 mx-auto" />
              <h3 className="text-sm font-semibold text-foreground">Confirm Your Email</h3>
            ...
            <CardContent className="space-y-4 pt-2">
              ...
              <div className="relative my-3">
                ...
                <div className="relative flex justify-center text-[10px] uppercase">
                  <span className="bg-[#0C0C12] px-2 text-muted-foreground font-mono">or register with email</span>
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                <Label htmlFor="password" className="text-xs">Password (min 6 characters)</Label>
                <Input
                  id="password"
                  type="password"
                  placeholder="••••••••"
